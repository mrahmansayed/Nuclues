        ...
        <div class="gap no-gap">
            <div class="inner-bg">
              ...
              <div class="col-md-6">
                ...
                <input type="text" placeholder="subtitle" name="slug" value="{{ $blog->slug }}">
              </div>
              <div class="col-md-6">
                ...
                <option {{ $blogcategory->id == $blog->blogcategories_id ? 'selected' : '' }} value="{{ $blogcategory->id }}">{{ $blogcategory->name }}</option>
                @endforeach
                </select>
              </div>
                <div class="col-md-6">
                    <br>
                <label>User</label>
                <input type="text" placeholder="User name" name="user" value="{{ $blog->user }}">
              </div>
              
              <div class="col-md-12">
                <br>
                <label>blog Description</label>
                <textarea cols="30" rows="10" id="description" placeholder="Enter Description" name="description">{{ $blog->description }}</textarea>
              </div>
