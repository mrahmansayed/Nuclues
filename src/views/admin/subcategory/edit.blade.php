        ...
        <div class="gap no-gap">
            <div class="inner-bg">
              ...
              <div class="add-prod-from">
                ...
                <form action="{{ route('navigation.update',$navigation->id) }}" method="POST"  enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input type="text" placeholder="Name" name="name" value="{{ $navigation->name }}">
              </div>
